...
?>
 ...
 <li>
<a href="rms.php?page=home"><i class="fa fa-fw fa-dashboard"></i> Сontrol Panel</a>
</li>
<li>
<a id=demo1 href="javascript:void(0)" data-toggle="collapse" data-target="#masterlistCollapse"><i class="fa fa-fw fa-files-o"></i> Student Info <i class="fa fa-fw fa-caret-down"></i></a>
